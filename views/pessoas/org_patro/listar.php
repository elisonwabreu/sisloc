                                ...
                                <div class="tabbable tabbable-bordered">
                                    ...
                                    <div class="tab-content"><!-- Listagem de pessoa fisica -->
                                        <div id="pf" class="tab-pane active">
                                            <ul class="ico-list">
                                                <li><a href="?modulo=pessoas/org_patro&url=cadastrar" alt="Novo Patrocinador" title="Novo Patrocinador"><i class="splashy-add"></i></a></li>
                                                <li><a href="?modulo=pessoas/org_patro&url=editar" alt="Editar Patrocinador" title="Editar Patrocinador"><i class="splashy-pencil"></i></a></li>
                                                <li><a href="#" alt="Excluir Patrocinador" title="Excluir funcionario"><i class="splashy-error_x"></i></a></li>
                                            </ul>
                                            <!-- DATATABLES -->    
