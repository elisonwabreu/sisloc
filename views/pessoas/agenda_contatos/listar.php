                                ...
                                <div class="tabbable tabbable-bordered">
                                    ...
                                    <div class="tab-content"><!-- Listagem de pessoa fisica -->
                                        <div id="pf" class="tab-pane active">
                                            <ul class="ico-list">
                                                <li><a href="?modulo=pessoas/agenda_contatos&url=cadastrar" alt="Novo funcionario" title="Novo funcionario"><i class="splashy-add"></i></a></li>
                                                <li><a href="?modulo=pessoas/agenda_contatos&url=editar" alt="Editar funcionario" title="Editar funcionario"><i class="splashy-pencil"></i></a></li>
