                                ...
                                <div class="tabbable tabbable-bordered">
                                    ...
                                    <div class="tab-content"><!-- Listagem de pessoa fisica -->
                                        <div id="pf" class="tab-pane active">
                                            <ul class="ico-list">
                                                <li><a href="?modulo=trajes/trajes&url=cadastrar" alt="Novo traje" title="Novo traje"><i class="splashy-add"></i></a></li>
                                                <li><a href="?modulo=trajes/trajes&url=editar" alt="Editar traje" title="Editar traje"><i class="splashy-pencil"></i></a></li>
                                                <li><a href="#" alt="Excluir traje" title="Excluir traje"><i class="splashy-error_x"></i></a></li>
                                            </ul>
                                            <!-- DATATABLES -->    
