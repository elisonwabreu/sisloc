                ...
                <div class="w-box-content cnt_b">
                    <div class="tabbable tabbable-bordered">
                        <ul class="nav nav-tabs">
                            <li class="active"><a data-toggle="tab" href="#pf"><?php $mTitle->trocarTitulo($_GET['url'], $_GET['modulo']); //realiza a mudança do titulo automaticamente    ?></a></li>
                        </ul>
                            ...
                            <div id="pf" class="tab-pane active">
                                ...
                                <div class="formSep">
                                    <div class="mbox_toolbar clearfix">
                                        <a href="?modulo=trajes/trajes&url=cadastrar" alt="Novo traje" title="Novo traje"><i class="icsw32-document"></i></a>
                                        <a href="?modulo=trajes/trajes&url=editar" alt="Editar traje" title="Editar traje"><i class="icsw32-pencil"></i></i></a>
                                        <a href="#" alt="Excluir traje" title="Excluir traje"><i class="icsw32-trashcan"></i></i></a>
                                    </div>
                                </div>
