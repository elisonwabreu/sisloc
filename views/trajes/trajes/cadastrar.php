                ...
                <div class="w-box-content cnt_b">
                    <div class="tabbable tabbable-bordered">
                        <ul class="nav nav-tabs">
                            <li class="active"><a data-toggle="tab" href="#infP" class="abas">Informações Pessoais</a></li>
                            <li ><a data-toggle="tab" href="#listTR">Listagem</a></li>
                        </ul>
                        <div class="tab-content"><!-- informações pessoais -->
                            ...
                            <div class="formSep" id="btnsForms">
